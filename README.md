...
- PDF çıktıları, eğer mevcutsa `client/assets/DejaVuSans.ttf` ve `DejaVuSans-Bold.ttf` fontlarını kullanarak Türkçe karakterleri tam destekleyecek şekilde üretilir; lisans gereği fontlar repo içinde yoktur, dosyaları aynı dizine manuel ekleyin.
