...
6. Veri alanı kutucuklarından (ör. web sitesi, varsayılan işletme görseli, kart görseli, paylaşım bağlantısı) ihtiyacınız olanları açık bırakın; kapalı olan alanlar hem taranmaz hem de çıktı dosyalarına eklenmez.
