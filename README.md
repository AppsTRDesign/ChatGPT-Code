...
- **Endpoint’ler:**
  ...
  - `GET /sites/{id}/stats` — site bazında ülke/cihaz/IP ve aksiyon adetleri ile günlük/haftalık/aylık bar serilerini döndürür.
...
- **Özellikler:**
  ...
  - Site detayları: her kayıtlı site için “Detaylar” butonu; ülke/şehir/IP/platform/cihaz ve aksiyon adetleri tablo halinde, günlük/haftalık/aylık çift renkli bar grafikleri ve tek tıkla PDF dışa aktarma.
