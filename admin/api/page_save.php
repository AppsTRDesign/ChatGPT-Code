...
try {
  ...
  $pdo->prepare('INSERT INTO page_translations(page_id,lang_code,title,content_html) VALUES(:pid,:lang,:title,:content) ON DUPLICATE KEY UPDATE title=VALUES(title), content_html=VALUES(content_html)')->execute(['pid'=>$pageId,'lang'=>$lang,'title'=>$title,'content'=>$content]);
  $pdo->commit();
