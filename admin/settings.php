            ...
            <div class="media-grid">
                <?php if ($logo): ?>
                    <div class="media-preview" data-remove-on-delete>
                        ...
                        <button class="btn danger" type="button" data-delete-setting-image="logo">Logo Sil</button>
                    </div>
                <?php endif; ?>
                <?php if ($favicon): ?>
                    <div class="media-preview" data-remove-on-delete>
                        <img src="<?= htmlspecialchars($favicon) ?>" alt="Favicon">
                        <button class="btn danger" type="button" data-delete-setting-image="favicon">Favicon Sil</button>
                    </div>
                <?php endif; ?>
            </div>
