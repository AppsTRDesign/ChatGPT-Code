...
private fun MainScaffold(navController: NavHostController, appState: AppStateViewModel) {
    ...
    val nestedScrollConnection = remember {
        object : NestedScrollConnection {
            override fun onPreScroll(available: Offset, source: NestedScrollSource): Offset {
                ...
                // Hassasiyeti biraz artırarak (0.5f -> 5f) istemsiz titremeleri engelliyoruz
                if (delta < -5f && bottomBarVisible.value) {
                    bottomBarVisible.value = false
                } else if (delta > 5f && !bottomBarVisible.value) {
    ...
    // Rota değiştiğinde barı her zaman geri getir
    ...
    Scaffold(
        ...
        bottomBar = {
            // Sadece ülke seçimi değilse ve rota null değilse göster
