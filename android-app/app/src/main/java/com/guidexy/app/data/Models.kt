...
data class PlacesFavoritesResponse(
    val success: Boolean,
    val places: List<PlaceDto>,
    val total: Int? = null,
    val page: Int? = null,
...
data class RecentReviewDto(
    ...
    val text_extra: List<ReviewExtraDto> = emptyList(),
    val review_photo_urls: List<String> = emptyList(),
    val likes_count: Int = 0
)

data class RecentReviewsResponse(
    val success: Boolean? = null,
    val reviews: List<RecentReviewDto> = emptyList(),
    val total: Int = 0,
    val page: Int = 1,
    val per_page: Int = 0,
...
data class UserReviewItemDto(
    ...
    val rating: Int,
    val text: String?,
    val text_extra: Map<String, String>? = null,
    val created_at: String?,
    val status: String?,
    val reply: ReviewReplyDto? = null
)
...
data class PlaceFavoriteRequest(
    val type: String = "place_favorite",
    val place_id: Long,
    val action: String,
    val user_id: Long,
    val user_role: String?
...
data class PlaceFavoriteResponse(
    val success: Boolean? = null,
    val error: String? = null,
    val is_favorite: Boolean? = null
)

data class PlaceFavoritesResponse(
    val success: Boolean? = null,
