...
class PlacesRepository(private val api: ApiService = ApiClient.service) {
    ...
    suspend fun getFavorites(
        ...
        lat: Double? = null,
        lng: Double? = null
    ) = api.favorites(code, perPage, page, sort, lat, lng)
    ...
    suspend fun getRecentReviews(perPage: Int, page: Int, countryCode: String? = null) =
        api.recentReviews(perPage, page, countryCode)
