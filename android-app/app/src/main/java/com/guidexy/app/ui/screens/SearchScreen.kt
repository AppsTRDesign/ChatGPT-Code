...
fun SearchScreen(viewModel: AppStateViewModel, navController: NavController) {
    ...
    LazyColumn(
            ...
            Card(modifier = Modifier.fillMaxWidth()) {
                Column(
                    ...
                    Row(horizontalArrangement = Arrangement.spacedBy(12.dp)) {
                        ...
                        TextButton(onClick = { showList.value = !showList.value }) {
                            Text(if (showList.value) "Harita" else "Liste")
                        }
                    }
                }
            }
        ...
        item {
            if (!showList.value && searchResults.isNotEmpty()) {
                LazyRow(horizontalArrangement = Arrangement.spacedBy(8.dp)) {
                    items(searchResults.take(10)) { place ->
