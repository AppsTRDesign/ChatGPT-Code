...
final class ActionController
{
    ...
    public function regionAction(Request $request): void
    {
        ...
        try {
            ...
            $status = match ($error) {
                'unauthorized' => 401,
                'invalid_action', 'Invalid action', 'invalid_region', 'Invalid region', 'same_region', 'Already in this region', 'already_traveling', 'Already traveling', 'not_enough_energy', 'not_enough_coins', 'Not enough coins', 'not_enough_resources' => 400,
                default => 400,
            };
