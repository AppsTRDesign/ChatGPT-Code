...
class PaymentService
{
    public static function createCheckout(array $payload): array
    {
        try {
            ...
            $request->setConversationId($payload['conversation_id'] ?? uniqid('payment_', false));
            ...
            return [
                ...
                'checkout_form' => $response->getCheckoutFormContent(),
                'raw' => json_decode($response->getRawResult(), true)
            ];
