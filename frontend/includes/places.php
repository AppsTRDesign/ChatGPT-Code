...
try {
    ...
    switch ($sort) {
        case 'rating':
            $order = 'combined_rating DESC, total_reviews DESC, p.created_at DESC';
            break;
        case 'reviews':
            $order = 'total_reviews DESC, combined_rating DESC, p.created_at DESC';
            break;
        case 'views':
            $order = 'views DESC, combined_rating DESC, p.created_at DESC';
            break;
        default:
            $order = 'p.created_at DESC';
    }
