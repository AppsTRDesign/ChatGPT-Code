    ...
    <div class="col-12 col-md-6 col-lg-4">
      <div class="card card-hover h-100">
        <div class="card-body">
          ...
          <div class="small mb-2">Kategori: <a class="text-decoration-none" title="<?= htmlspecialchars($place['business_type']) ?>" href="<?= category_url($place['category_slug'] ?? '') ?>"><?= htmlspecialchars($place['business_type']) ?></a></div>
...
<?php if (!empty($totalPages) && !empty($baseUrl)): ?>
  <?= render_pagination_links($page ?? 1, $totalPages, $baseUrl, $queryParams ?? []); ?>
<?php endif; ?>
