...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    ...
    "es": {
        "app_title": "Herramienta de Negocios de Google Maps",
        "tab_api": "Escanear con API",
        "tab_bot": "Escanear con Bot",
        "tab_settings": "Ajustes",
        "tab_api_settings": "Puente API",
        "api_key": "Clave API",
        "query": "Búsqueda",
        "language": "Idioma",
        "search": "Buscar",
        "result_limit": "Cantidad de negocios",
        "results": "Resultados",
        "details": "Detalles",
        "search_panel": "Opciones de búsqueda",
        "column_name": "Nombre",
        "column_phone": "Teléfono",
        "column_rating": "Valoración",
        "column_category": "Categoría",
        "column_phone_type": "Tipo de teléfono",
        "column_lat": "Latitud",
        "column_lng": "Longitud",
        "column_website": "Sitio web",
        "column_image": "Imagen del negocio",
        "review_limit": "Cantidad de reseñas",
        "save_json": "Guardar JSON",
        "save_csv": "Guardar CSV",
        "save_pdf": "Guardar PDF",
        "transfer_data": "Transferir datos",
        "status_ready": "Listo",
        "status_searching": "Buscando...",
        "status_scraping_progress": "{}/{} negocios escaneados",
        "status_error": "Ocurrió un error",
        "error_title": "Error",
        "error_missing_key": "Ingrese la clave API.",
        "error_missing_query": "Ingrese un término de búsqueda.",
        "error_check_logs": "Revise el archivo de registro para más detalles.",
        "error_unknown": "Error desconocido.",
        "error_no_results_to_save": "No hay resultados para guardar.",
        ...
        "map_preview_placeholder": "Sin vista previa",
        "address": "Dirección",
        "opening_hours": "Horario",
        "reviews": "Reseñas de clientes",
        "review_author": "Autor",
        "review_rating": "Puntuación",
        "review_time": "Fecha",
        "review_text": "Reseña",
        "review_profile": "Foto de perfil",
        "review_media": "Fotos de reseña",
        "ratings_total": "Total de valoraciones",
        "busy_hours": "Horas populares",
        "save_xlsx": "Guardar XLSX",
        "field_section": "Campos de datos",
        "field_name": "Nombre",
        "field_formatted_address": "Dirección",
        "field_formatted_phone_number": "Teléfono",
        "field_business_type": "Tipo de negocio",
        "field_opening_hours": "Horario",
        "field_rating": "Valoración",
        "field_user_ratings_total": "Cantidad de valoraciones",
        "field_location": "Ubicación",
        "field_business_image": "Imagen del negocio",
        "field_website": "Sitio web",
        "field_reviews": "Reseñas",
        "field_review_photo_urls": "Fotos de reseñas",
        "field_text_extra": "Extras de reseñas",
        "field_busy_hours": "Horas populares",
        "city": "Ciudad",
        "settings_panel": "Ajustes globales",
        "settings_search_limit": "Máx. negocios",
        "settings_review_limit": "Máx. reseñas",
        "settings_api_url": "URL de API",
        "settings_api_token": "Token de API",
        "settings_apply": "Aplicar",
        "settings_api_panel": "Puente API",
        "settings_api_hint": "Endpoint y token usados al transferir resultados",
        "error_missing_api_url": "Ingrese un endpoint de API.",
        "transfer_success": "Datos transferidos con éxito.",
        "transfer_failed": "Fallo al transferir datos.",
        "settings_saved": "Ajustes actualizados.",
        "log_search_started": "Búsqueda iniciada: {query}",
        "log_click_card": "Se hace clic en la tarjeta: {name}",
        "log_panel_opened": "Panel abierto: {name}",
        "log_panel_failed": "Panel no se abrió: {name}",
        "log_result_captured": "Datos capturados: {name}",
        "log_search_finished": "Búsqueda finalizada. Total: {count}",
        "log_search_failed": "Fallo de bot: {message}",
        "app_tagline": "Combina escaneos API y bot en un panel",
        "tab_license": "Licencia",
        "license_info_group": "Estado de licencia",
        "license_activation_group": "Activación de licencia",
        "license_machine_id": "ID de máquina",
        "license_copy_id": "Copiar ID",
        "license_status_valid": "Licencia: Activa",
        "license_status_invalid": "Licencia: Inactiva",
        "license_days_left": "Días restantes",
        "license_expiry": "Vencimiento",
        "license_duration": "Duración",
        "license_key": "Clave de licencia",
        "license_activate": "Activar licencia",
        "license_machine_copied": "ID copiado al portapapeles.",
        "license_missing_key": "Se requiere clave de licencia.",
        "license_invalid_key": "No se pudo validar la licencia.",
        "license_success": "Licencia activada.",
        "license_required": "Active una licencia válida antes de ejecutar.",
        "duration_years": "años",
        "duration_months": "meses",
        "duration_days": "días",
        "pdf_title": "Informe de Google Maps",
        "pdf_unknown": "Desconocido",
    },
    "it": {
        "app_title": "Strumento Business Google Maps",
        "tab_api": "Scansione API",
        "tab_bot": "Scansione Bot",
        "tab_settings": "Impostazioni",
        "tab_api_settings": "Bridge API",
        "api_key": "Chiave API",
        "query": "Ricerca",
        "language": "Lingua",
        "search": "Cerca",
        "result_limit": "Numero aziende",
        "results": "Risultati",
        "details": "Dettagli",
        ...
        "column_phone_type": "Tipo telefono",
        "column_lat": "Latitudine",
        "column_lng": "Longitudine",
        "column_website": "Sito web",
        "column_image": "Immagine azienda",
        "review_limit": "Numero recensioni",
        "save_json": "Salva JSON",
        "save_csv": "Salva CSV",
        "save_pdf": "Salva PDF",
        "transfer_data": "Trasferisci dati",
        "status_ready": "Pronto",
        "status_searching": "Ricerca in corso...",
        "status_scraping_progress": "{}/{} aziende analizzate",
        "status_error": "Si è verificato un errore",
        "error_title": "Errore",
        "error_missing_key": "Inserire la chiave API.",
        "error_missing_query": "Inserire un termine di ricerca.",
        "error_check_logs": "Controlla i log per dettagli.",
        "error_unknown": "Errore sconosciuto.",
        "error_no_results_to_save": "Nessun risultato da salvare.",
        "info_title": "Info",
        "save_success": "File salvato con successo.",
        "save_error": "Impossibile salvare il file.",
        "no_results": "Nessun risultato trovato.",
        "map_preview": "Anteprima mappa",
        "map_preview_placeholder": "Nessuna anteprima",
        "address": "Indirizzo",
        "opening_hours": "Orari",
        "reviews": "Recensioni clienti",
        "review_author": "Autore",
        "review_rating": "Voto",
        "review_time": "Data",
        "review_text": "Recensione",
        "review_profile": "Foto profilo",
        "review_media": "Foto recensione",
        "ratings_total": "Totale valutazioni",
        "busy_hours": "Orari affollati",
        "save_xlsx": "Salva XLSX",
        "field_section": "Campi dati",
        "field_name": "Nome",
        "field_formatted_address": "Indirizzo",
        "field_formatted_phone_number": "Telefono",
        "field_business_type": "Tipo attività",
        "field_opening_hours": "Orari",
        "field_rating": "Valutazione",
        "field_user_ratings_total": "Numero valutazioni",
        "field_location": "Posizione",
        "field_business_image": "Immagine attività",
        "field_website": "Sito web",
        "field_reviews": "Recensioni",
        "field_review_photo_urls": "Foto recensione",
        "field_text_extra": "Extra recensione",
        "field_busy_hours": "Orari affollati",
        "city": "Città",
        "settings_panel": "Impostazioni generali",
        "settings_search_limit": "Max aziende",
        "settings_review_limit": "Max recensioni",
        "settings_api_url": "Endpoint API",
        "settings_api_token": "Token API",
        "settings_apply": "Applica",
        "settings_api_panel": "Bridge API",
        "settings_api_hint": "Endpoint e token per il trasferimento",
        "error_missing_api_url": "Inserire l'endpoint API.",
        "transfer_success": "Dati trasferiti con successo.",
        "transfer_failed": "Trasferimento fallito.",
        "settings_saved": "Impostazioni aggiornate.",
        "log_search_started": "Ricerca avviata: {query}",
        "log_click_card": "Click sulla scheda: {name}",
        "log_panel_opened": "Pannello aperto: {name}",
        "log_panel_failed": "Pannello non aperto: {name}",
        "log_result_captured": "Dati acquisiti: {name}",
        "log_search_finished": "Ricerca completata. Totale: {count}",
        "log_search_failed": "Errore bot: {message}",
        "app_tagline": "Unisci scansioni API e bot in un'unica app",
        "tab_license": "Licenza",
        "license_info_group": "Stato licenza",
        "license_activation_group": "Attivazione licenza",
        "license_machine_id": "ID macchina",
        "license_copy_id": "Copia ID",
        "license_status_valid": "Licenza: Attiva",
        "license_status_invalid": "Licenza: Inattiva",
        "license_days_left": "Giorni restanti",
        "license_expiry": "Scadenza",
        "license_duration": "Durata",
        "license_key": "Chiave licenza",
        "license_activate": "Attiva licenza",
        "license_machine_copied": "ID copiato negli appunti.",
        "license_missing_key": "Chiave licenza obbligatoria.",
        "license_invalid_key": "Licenza non valida.",
        "license_success": "Licenza attivata.",
        "license_required": "Attiva una licenza valida prima di eseguire.",
        "duration_years": "anni",
        "duration_months": "mesi",
        "duration_days": "giorni",
        "pdf_title": "Report Google Maps",
        "pdf_unknown": "Sconosciuto",
    },
    "fr": {
        "app_title": "Outil Google Maps Entreprises",
        "tab_api": "Scan via API",
        "tab_bot": "Scan via Bot",
        "tab_settings": "Paramètres",
        "tab_api_settings": "Passerelle API",
        "api_key": "Clé API",
        "query": "Requête",
        "language": "Langue",
        "search": "Rechercher",
        "result_limit": "Nombre d'entreprises",
        "results": "Résultats",
        "details": "Détails",
        ...
        "column_phone_type": "Type de téléphone",
        "column_lat": "Latitude",
        "column_lng": "Longitude",
        "column_website": "Site web",
        "column_image": "Image entreprise",
        "review_limit": "Nombre d'avis",
        "save_json": "Enregistrer JSON",
        "save_csv": "Enregistrer CSV",
        "save_pdf": "Enregistrer PDF",
        "transfer_data": "Transférer",
        "status_ready": "Prêt",
        "status_searching": "Recherche...",
        "status_scraping_progress": "{}/{} entreprises scannées",
        "status_error": "Une erreur s'est produite",
        "error_title": "Erreur",
        "error_missing_key": "Veuillez saisir la clé API.",
        "error_missing_query": "Veuillez saisir une requête.",
        "error_check_logs": "Consultez le journal pour plus de détails.",
        "error_unknown": "Erreur inconnue.",
        "error_no_results_to_save": "Aucun résultat à enregistrer.",
        "info_title": "Info",
        "save_success": "Fichier enregistré.",
        "save_error": "Enregistrement impossible.",
        "no_results": "Aucun résultat.",
        "map_preview": "Aperçu carte",
        "map_preview_placeholder": "Aucun aperçu",
        "address": "Adresse",
        ...
        "review_time": "Date",
        "review_text": "Avis",
        "review_profile": "Photo de profil",
        "review_media": "Photos d'avis",
        "ratings_total": "Total des notes",
        "busy_hours": "Heures d'affluence",
        "save_xlsx": "Enregistrer XLSX",
        "field_section": "Champs de données",
        "field_name": "Nom",
        "field_formatted_address": "Adresse",
        "field_formatted_phone_number": "Téléphone",
        "field_business_type": "Type d'entreprise",
        "field_opening_hours": "Horaires",
        "field_rating": "Note",
        "field_user_ratings_total": "Nombre de notes",
        "field_location": "Position",
        "field_business_image": "Image",
        "field_website": "Site web",
        "field_reviews": "Avis",
        "field_review_photo_urls": "Photos d'avis",
        "field_text_extra": "Infos supplémentaires",
        "field_busy_hours": "Heures d'affluence",
        "city": "Ville",
        "settings_panel": "Paramètres globaux",
        "settings_search_limit": "Max entreprises",
        "settings_review_limit": "Max avis",
        "settings_api_url": "Endpoint API",
        "settings_api_token": "Jeton API",
        "settings_apply": "Appliquer",
        "settings_api_panel": "Passerelle API",
        "settings_api_hint": "Endpoint et jeton utilisés pour le transfert",
        "error_missing_api_url": "Saisissez un endpoint API.",
        "transfer_success": "Transfert réussi.",
        "transfer_failed": "Échec du transfert.",
        "settings_saved": "Paramètres mis à jour.",
        "log_search_started": "Recherche démarrée: {query}",
        "log_click_card": "Clic sur la fiche: {name}",
        "log_panel_opened": "Panneau ouvert: {name}",
        "log_panel_failed": "Panneau non ouvert: {name}",
        "log_result_captured": "Données capturées: {name}",
        "log_search_finished": "Recherche terminée. Total: {count}",
        "log_search_failed": "Échec du bot: {message}",
        "app_tagline": "Combinez scans API et bot dans un seul outil",
        "tab_license": "Licence",
        "license_info_group": "Statut de licence",
        "license_activation_group": "Activation",
        "license_machine_id": "ID machine",
        "license_copy_id": "Copier ID",
        "license_status_valid": "Licence: Active",
        "license_status_invalid": "Licence: Inactive",
        "license_days_left": "Jours restants",
        "license_expiry": "Expiration",
        "license_duration": "Durée",
        "license_key": "Clé de licence",
        "license_activate": "Activer",
        "license_machine_copied": "ID copié.",
        "license_missing_key": "Clé requise.",
        "license_invalid_key": "Licence invalide.",
        "license_success": "Licence activée.",
        "license_required": "Activez une licence valide avant d'exécuter.",
        "duration_years": "années",
        "duration_months": "mois",
        "duration_days": "jours",
        "pdf_title": "Rapport Google Maps",
        "pdf_unknown": "Inconnu",
    },
    "de": {
        "app_title": "Google Maps Business Tool",
        "tab_api": "Per API scannen",
        "tab_bot": "Per Bot scannen",
        ...
        "language": "Sprache",
        "search": "Suchen",
        "result_limit": "Anzahl Unternehmen",
        "results": "Ergebnisse",
        "details": "Details",
        "search_panel": "Suchoptionen",
        "column_name": "Name",
        "column_phone": "Telefon",
        "column_rating": "Bewertung",
        "column_category": "Kategorie",
        "column_phone_type": "Telefontyp",
        "column_lat": "Breite",
        "column_lng": "Länge",
        "column_website": "Webseite",
        "column_image": "Unternehmensbild",
        "review_limit": "Anzahl Bewertungen",
        ...
        "status_scraping_progress": "{}/{} Unternehmen gescannt",
        "status_error": "Ein Fehler ist aufgetreten",
        "error_title": "Fehler",
        "error_missing_key": "API-Schlüssel eingeben.",
        "error_missing_query": "Suchbegriff eingeben.",
        "error_check_logs": "Logdatei prüfen.",
        "error_unknown": "Unbekannter Fehler.",
        "error_no_results_to_save": "Keine Ergebnisse zu speichern.",
        "info_title": "Info",
        "save_success": "Datei gespeichert.",
        "save_error": "Datei konnte nicht gespeichert werden.",
        "no_results": "Keine Ergebnisse.",
        "map_preview": "Kartenvorschau",
        "map_preview_placeholder": "Keine Vorschau",
        "address": "Adresse",
        ...
        "review_profile": "Profilfoto",
        "review_media": "Bewertungsfotos",
        "ratings_total": "Bewertungen gesamt",
        "busy_hours": "Stoßzeiten",
        "save_xlsx": "XLSX speichern",
        "field_section": "Datenfelder",
        "field_name": "Name",
        "field_formatted_address": "Adresse",
        "field_formatted_phone_number": "Telefon",
        "field_business_type": "Unternehmenstyp",
        "field_opening_hours": "Öffnungszeiten",
        "field_rating": "Bewertung",
        "field_user_ratings_total": "Anzahl Bewertungen",
        "field_location": "Standort",
        "field_business_image": "Unternehmensbild",
        "field_website": "Webseite",
        "field_reviews": "Bewertungen",
        "field_review_photo_urls": "Bewertungsfotos",
        "field_text_extra": "Zusatzinfos",
        "field_busy_hours": "Stoßzeiten",
        "city": "Stadt",
        "settings_panel": "Globale Einstellungen",
        "settings_search_limit": "Max Unternehmen",
        "settings_review_limit": "Max Bewertungen",
        "settings_api_url": "API-Endpoint",
        "settings_api_token": "API-Token",
        "settings_apply": "Anwenden",
        "settings_api_panel": "API-Bridge",
        "settings_api_hint": "Endpoint und Token für Übertragung",
        "error_missing_api_url": "API-Endpoint eingeben.",
        "transfer_success": "Daten übertragen.",
        "transfer_failed": "Übertragung fehlgeschlagen.",
        "settings_saved": "Einstellungen aktualisiert.",
        "log_search_started": "Suche gestartet: {query}",
        "log_click_card": "Karte angeklickt: {name}",
        "log_panel_opened": "Detail geöffnet: {name}",
        "log_panel_failed": "Detail nicht geöffnet: {name}",
        "log_result_captured": "Daten erfasst: {name}",
        "log_search_finished": "Suche beendet. Gesamt: {count}",
        "log_search_failed": "Bot-Fehler: {message}",
        "app_tagline": "API- und Bot-Scans in einem Tool vereinen",
        "tab_license": "Lizenz",
        "license_info_group": "Lizenzstatus",
        "license_activation_group": "Lizenzaktivierung",
        "license_machine_id": "Maschinen-ID",
        "license_copy_id": "ID kopieren",
        "license_status_valid": "Lizenz: Aktiv",
        "license_status_invalid": "Lizenz: Inaktiv",
        "license_days_left": "Verbleibende Tage",
        "license_expiry": "Ablauf",
        "license_duration": "Dauer",
        "license_key": "Lizenzschlüssel",
        "license_activate": "Lizenz aktivieren",
        "license_machine_copied": "ID kopiert.",
        "license_missing_key": "Lizenzschlüssel erforderlich.",
        "license_invalid_key": "Lizenz ungültig.",
        "license_success": "Lizenz aktiviert.",
        "license_required": "Aktivieren Sie eine gültige Lizenz vor dem Start.",
        "duration_years": "Jahre",
        "duration_months": "Monate",
        "duration_days": "Tage",
        "pdf_title": "Google-Maps-Bericht",
        "pdf_unknown": "Unbekannt",
    },
    "pt": {
        "app_title": "Ferramenta de Negócios do Google Maps",
        "tab_api": "Examinar via API",
        "tab_bot": "Examinar via Bot",
        "tab_settings": "Configurações",
        "tab_api_settings": "Ponte API",
        "api_key": "Chave API",
        "query": "Busca",
        "language": "Idioma",
        "search": "Pesquisar",
        "result_limit": "Número de empresas",
        "results": "Resultados",
        "details": "Detalhes",
        "search_panel": "Opções de busca",
        "column_name": "Nome",
        "column_phone": "Telefone",
        "column_rating": "Avaliação",
        "column_category": "Categoria",
        "column_phone_type": "Tipo de telefone",
        "column_lat": "Latitude",
        "column_lng": "Longitude",
        "column_website": "Site",
        "column_image": "Imagem da empresa",
        "review_limit": "Número de avaliações",
        "save_json": "Salvar JSON",
        "save_csv": "Salvar CSV",
        "save_pdf": "Salvar PDF",
        "transfer_data": "Transferir dados",
        "status_ready": "Pronto",
        "status_searching": "Pesquisando...",
        "status_scraping_progress": "{}/{} empresas analisadas",
        "status_error": "Ocorreu um erro",
        "error_title": "Erro",
        "error_missing_key": "Insira a chave API.",
        "error_missing_query": "Insira um termo de busca.",
        "error_check_logs": "Verifique o log para detalhes.",
        "error_unknown": "Erro desconhecido.",
        "error_no_results_to_save": "Sem resultados para salvar.",
        "info_title": "Info",
        "save_success": "Arquivo salvo.",
        "save_error": "Não foi possível salvar.",
        "no_results": "Nenhum resultado.",
        "map_preview": "Prévia do mapa",
        "map_preview_placeholder": "Sem prévia",
        "address": "Endereço",
        ...
        "review_rating": "Nota",
        "review_time": "Data",
        "review_text": "Avaliação",
        "review_profile": "Foto de perfil",
        "review_media": "Fotos da avaliação",
        "ratings_total": "Total de notas",
        "busy_hours": "Horários de pico",
        "save_xlsx": "Salvar XLSX",
        "field_section": "Campos de dados",
        "field_name": "Nome",
        "field_formatted_address": "Endereço",
        "field_formatted_phone_number": "Telefone",
        "field_business_type": "Tipo de negócio",
        "field_opening_hours": "Horário",
        "field_rating": "Avaliação",
        "field_user_ratings_total": "Total de avaliações",
        "field_location": "Localização",
        "field_business_image": "Imagem da empresa",
        "field_website": "Site",
        "field_reviews": "Avaliações",
        "field_review_photo_urls": "Fotos de avaliações",
        "field_text_extra": "Extras",
        "field_busy_hours": "Horários de pico",
        "city": "Cidade",
        "settings_panel": "Configurações globais",
        "settings_search_limit": "Máx empresas",
        "settings_review_limit": "Máx avaliações",
        "settings_api_url": "Endpoint API",
        "settings_api_token": "Token API",
        "settings_apply": "Aplicar",
        "settings_api_panel": "Ponte API",
        "settings_api_hint": "Endpoint e token usados na transferência",
        "error_missing_api_url": "Informe o endpoint.",
        "transfer_success": "Dados transferidos.",
        "transfer_failed": "Falha na transferência.",
        "settings_saved": "Configurações atualizadas.",
        "log_search_started": "Busca iniciada: {query}",
        "log_click_card": "Clique no cartão: {name}",
        "log_panel_opened": "Painel aberto: {name}",
        "log_panel_failed": "Painel falhou: {name}",
        "log_result_captured": "Dados capturados: {name}",
        "log_search_finished": "Busca finalizada. Total: {count}",
        "log_search_failed": "Falha do bot: {message}",
        "app_tagline": "Combine buscas API e bot em um só painel",
        "tab_license": "Licença",
        "license_info_group": "Status da licença",
        "license_activation_group": "Ativação",
        "license_machine_id": "ID da máquina",
        "license_copy_id": "Copiar ID",
        "license_status_valid": "Licença: Ativa",
        "license_status_invalid": "Licença: Inativa",
        "license_days_left": "Dias restantes",
        "license_expiry": "Expiração",
        "license_duration": "Duração",
        "license_key": "Chave da licença",
        "license_activate": "Ativar licença",
        "license_machine_copied": "ID copiado.",
        "license_missing_key": "Chave necessária.",
        "license_invalid_key": "Licença inválida.",
        "license_success": "Licença ativada.",
        "license_required": "Ative uma licença antes de executar.",
        "duration_years": "anos",
        "duration_months": "meses",
        "duration_days": "dias",
        "pdf_title": "Relatório Google Maps",
        "pdf_unknown": "Desconhecido",
    },
    "ar": {
        "app_title": "أداة أعمال خرائط جوجل",
        "tab_api": "فحص عبر API",
        "tab_bot": "فحص عبر البوت",
        "tab_settings": "الإعدادات",
        "tab_api_settings": "جسر API",
        "api_key": "مفتاح API",
        "query": "بحث",
        "language": "اللغة",
        "search": "ابحث",
        "result_limit": "عدد الشركات",
        "results": "النتائج",
        "details": "التفاصيل",
        "search_panel": "خيارات البحث",
        "column_name": "الاسم",
        "column_phone": "الهاتف",
        "column_rating": "التقييم",
        "column_category": "الفئة",
        "column_phone_type": "نوع الهاتف",
        "column_lat": "خط العرض",
        "column_lng": "خط الطول",
        "column_website": "الموقع",
        "column_image": "صورة الشركة",
        "review_limit": "عدد المراجعات",
        "save_json": "حفظ JSON",
        "save_csv": "حفظ CSV",
        "save_pdf": "حفظ PDF",
        "transfer_data": "نقل البيانات",
        "status_ready": "جاهز",
        "status_searching": "جارٍ البحث...",
        "status_scraping_progress": "تم فحص {}/{} شركة",
        "status_error": "حدث خطأ",
        "error_title": "خطأ",
        "error_missing_key": "أدخل مفتاح API.",
        "error_missing_query": "أدخل عبارة البحث.",
        "error_check_logs": "راجع السجل للمزيد.",
        "error_unknown": "خطأ غير معروف.",
        "error_no_results_to_save": "لا نتائج للحفظ.",
        "info_title": "معلومات",
        "save_success": "تم حفظ الملف.",
        "save_error": "تعذر الحفظ.",
        "no_results": "لا توجد نتائج.",
        "map_preview": "معاينة الخريطة",
        "map_preview_placeholder": "لا توجد معاينة",
        "address": "العنوان",
        "opening_hours": "ساعات العمل",
        "reviews": "مراجعات العملاء",
        "review_author": "الكاتب",
        "review_rating": "التقييم",
        "review_time": "الوقت",
        "review_text": "المراجعة",
        "review_profile": "صورة الملف",
        "review_media": "صور المراجعة",
        "ratings_total": "إجمالي التقييمات",
        "busy_hours": "أوقات الذروة",
        "save_xlsx": "حفظ XLSX",
        "field_section": "حقول البيانات",
        "field_name": "الاسم",
        "field_formatted_address": "العنوان",
        "field_formatted_phone_number": "الهاتف",
        "field_business_type": "نوع النشاط",
        "field_opening_hours": "ساعات العمل",
        "field_rating": "التقييم",
        "field_user_ratings_total": "عدد التقييمات",
        "field_location": "الموقع",
        "field_business_image": "صورة النشاط",
        "field_website": "الموقع",
        "field_reviews": "المراجعات",
        "field_review_photo_urls": "صور المراجعات",
        "field_text_extra": "معلومات إضافية",
        "field_busy_hours": "أوقات الذروة",
        "city": "مدينة",
        "settings_panel": "إعدادات عامة",
        "settings_search_limit": "أقصى عدد شركات",
        "settings_review_limit": "أقصى عدد مراجعات",
        "settings_api_url": "عنوان API",
        "settings_api_token": "رمز API",
        "settings_apply": "تطبيق",
        "settings_api_panel": "جسر API",
        "settings_api_hint": "العنوان والرمز لنقل النتائج",
        "error_missing_api_url": "أدخل عنوان API.",
        "transfer_success": "تم نقل البيانات.",
        "transfer_failed": "فشل النقل.",
        "settings_saved": "تم تحديث الإعدادات.",
        "log_search_started": "بدأ البحث: {query}",
        "log_click_card": "نقرة على البطاقة: {name}",
        "log_panel_opened": "تم فتح اللوحة: {name}",
        "log_panel_failed": "تعذر فتح اللوحة: {name}",
        "log_result_captured": "تم جمع البيانات: {name}",
        "log_search_finished": "اكتمل البحث. المجموع: {count}",
        "log_search_failed": "فشل البوت: {message}",
        "app_tagline": "ادمج فحوصات API والبوت في أداة واحدة",
        "tab_license": "الترخيص",
        "license_info_group": "حالة الترخيص",
        "license_activation_group": "تفعيل الترخيص",
        "license_machine_id": "معرف الجهاز",
        "license_copy_id": "نسخ المعرف",
        "license_status_valid": "الترخيص: مفعل",
        "license_status_invalid": "الترخيص: غير مفعل",
        "license_days_left": "الأيام المتبقية",
        "license_expiry": "انتهاء",
        "license_duration": "المدة",
        "license_key": "مفتاح الترخيص",
        "license_activate": "تفعيل الترخيص",
        "license_machine_copied": "تم نسخ المعرف.",
        "license_missing_key": "مفتاح الترخيص مطلوب.",
        "license_invalid_key": "ترخيص غير صالح.",
        "license_success": "تم تفعيل الترخيص.",
        "license_required": "فعّل ترخيصاً صالحاً قبل البدء.",
        "duration_years": "سنوات",
        "duration_months": "أشهر",
        "duration_days": "أيام",
        "pdf_title": "تقرير خرائط جوجل",
        ...
        for place in results[:limit]:
            ...
            detailed_results.append(
                selection.apply(
                    PlaceResult(
                        city_name=self.city_name,
                        city_slug=slugify_city(self.city_name),
...
class GoogleMapsPlaywrightScraper:
    ...
    def _build_search_url(self, query: str) -> str:
        ...
        if self.city_center and all(self.city_center):
            ...
            return (
                f"{self.MAP_URL}/search/{encoded_query}/@{lat},{lng},21z"
    ...
    def _extract_details(self, page: Page) -> PlaceResult:
        ...
        if selection.location:
            latitude, longitude = self._extract_coordinates(page)
...
class Application(tk.Tk):
    ...
    def _create_widgets(self) -> None:
        ...
        self.language_combo = ttk.Combobox(
            ...
            values=["tr", "en", "es", "it", "fr", "ar", "pt", "de"],
            state="readonly",
        )
