...
$router->post('/api/gov-factory/job/start', [$apiController, 'govFactoryJobStart']);
$router->post('/api/v1/gov-factory/job/start', [$apiController, 'govFactoryJobStart']);
$router->post('/api/gov-factory/job/leave', [$apiController, 'govFactoryJobLeave']);
$router->post('/api/v1/gov-factory/job/leave', [$apiController, 'govFactoryJobLeave']);
...
$router->post('/admin/world/government-factories/seed', [$adminController, 'seedGovernmentFactories']);
