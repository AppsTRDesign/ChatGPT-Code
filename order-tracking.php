...
$orderStmt = db()->prepare('SELECT orders.*, shippers.name AS shipper_name, shippers.logo AS shipper_logo, shippers.website AS shipper_website, shippers.api_url AS shipper_api_url FROM orders LEFT JOIN shippers ON shippers.id = orders.shipper_id WHERE orders.id = :id');
