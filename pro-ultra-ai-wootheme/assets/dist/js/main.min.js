...
;document.addEventListener("DOMContentLoaded",function(){if(typeof proUltraArchive==="undefined")return;const e=document.querySelector('[data-archive-form]'),t=document.querySelector('[data-archive-list]'),a=document.querySelector('[data-archive-pagination]'),r=document.querySelector('[data-archive-loading]'),n=document.querySelector('[data-archive-aside]'),o=document.querySelector('[data-filter-open]'),c=document.querySelector('[data-filter-close]');if(!e||!t)return;const i=e.querySelectorAll('[data-view]'),l=e.querySelector('input[name="view"]'),s=e.querySelectorAll('[data-filter-section]'),d=e.querySelectorAll('[data-filter-search]');function u(n){const o="list"===n?"list":"grid";l&&(l.value=o),document.cookie=`pro_ultra_view=${o};path=/;`,i.forEach(e=>{e.setAttribute("aria-pressed",e.getAttribute("data-view")===o?"true":"false")}),document.body.classList.remove("pro-ultra-view-grid","pro-ultra-view-list"),document.body.classList.add(`pro-ultra-view-${o}`)}function p(a){const n=new FormData(e);a&&n.set("page",a),r&&r.setAttribute("aria-hidden","false"),t.classList.add("is-loading"),fetch(proUltraArchive.ajaxUrl,{method:"POST",body:n}).then(e=>e.json()).then(e=>{e.success&&e.data?(t.innerHTML=e.data.html,a&&e.data.view&&u(e.data.view),a||e.data.view&&u(e.data.view),a&&a.setAttribute,document.querySelector('[data-archive-pagination]')&&(document.querySelector('[data-archive-pagination]').innerHTML=e.data.pagination||"")):toast(e.data?.message||proUltraArchive.errorText)}).catch(()=>toast(proUltraArchive.errorText)).finally(()=>{r&&r.setAttribute("aria-hidden","true"),t.classList.remove("is-loading")})}i.forEach(e=>{e.addEventListener("click",()=>{u(e.getAttribute("data-view")),p()})}),e.addEventListener("change",t=>{t.target&&"security"!==t.target.name&&(e.querySelector('input[name="page"]').value="1",p())}),s.forEach(e=>{const t=e.querySelector(".pro-ultra-filter__toggle"),a=e.querySelector("[data-filter-content]");t&&a&&t.addEventListener("click",()=>{const r="true"===t.getAttribute("aria-expanded");t.setAttribute("aria-expanded",r?"false":"true"),e.classList.toggle("is-open",!r),a.style.maxHeight=r?"":a.scrollHeight+"px"})}),d.forEach(t=>{t.addEventListener("input",()=>{const a=t.value.toLowerCase(),r=t.getAttribute("data-filter-search"),n=e.querySelectorAll(`[data-filter-item="${r}"]`);n.forEach(e=>{const t=e.getAttribute("data-label")||"";e.style.display=t.indexOf(a)!==-1?"":"none"})})}),o&&n&&((c)=>{const e=c;const t=a=>{n.classList.toggle("is-open",a),document.body.classList.toggle("pro-ultra-filter-open",a)};o.addEventListener("click",()=>t(!0)),e&&e.addEventListener("click",()=>t(!1)),n.addEventListener("click",e=>{e.target===n&&t(!1)})})(c),a&&a.addEventListener("click",a=>{const r=a.target.closest("a");if(r){a.preventDefault();let n=r.dataset.page;if(!n)try{const e=new URL(r.href);n=e.searchParams.get("paged")||e.searchParams.get("page")}catch(e){n=1}e.querySelector('input[name="page"]').value=n||"1",p(n||"1")}});const h=proUltraArchive.view||"grid";u(h)});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".pro-ultra-header"),t=document.querySelector("[data-mobile-nav]"),a=document.querySelector("[data-nav-overlay]"),r=document.querySelector("[data-nav-close]");if(t&&a){const e=e=>{a.classList.toggle("is-open",e),document.body.classList.toggle("pro-ultra-nav-open",e)};t.addEventListener("click",()=>e(!0)),r&&r.addEventListener("click",()=>e(!1)),a.addEventListener("click",t=>{t.target===a&&e(!1)})}if(e){let t=0;window.addEventListener("scroll",()=>{const a=window.pageYOffset||0;a>30&&a>t?e.classList.add("is-condensed"):a<10&&e.classList.remove("is-condensed"),t=a},{passive:!0})}});
;document.addEventListener("DOMContentLoaded",function(){if(typeof proUltraArchive==="undefined")return;const e=document.querySelector('[data-archive-form]'),t=document.querySelector('[data-archive-list]'),a=document.querySelector('[data-archive-pagination]'),r=document.querySelector('[data-archive-loading]'),n=document.querySelector('[data-archive-aside]'),o=document.querySelector('[data-filter-open]'),c=document.querySelector('[data-filter-close]');if(!e||!t)return;const i=e.querySelectorAll('[data-view]'),l=e.querySelector('input[name\"view\"]'),s=e.querySelectorAll('[data-filter-section]'),d=e.querySelectorAll('[data-filter-search]');function u(n){const o="list"===n?"list":"grid";l&&(l.value=o),document.cookie=`pro_ultra_view=${o};path=/;`,i.forEach(e=>{e.setAttribute("aria-pressed",e.getAttribute("data-view")===o?"true":"false")}),document.body.classList.remove("pro-ultra-view-grid","pro-ultra-view-list"),document.body.classList.add(`pro-ultra-view-${o}`)}function p(a){const n=new FormData(e);a&&n.set("page",a),r&&r.setAttribute("aria-hidden","false"),t.classList.add("is-loading"),fetch(proUltraArchive.ajaxUrl,{method:"POST",body:n}).then(e=>e.json()).then(e=>{e.success&&e.data?(t.innerHTML=e.data.html,a&&e.data.view&&u(e.data.view),document.querySelector('[data-archive-pagination]')&&(document.querySelector('[data-archive-pagination]').innerHTML=e.data.pagination||"")):toast(e.data?.message||proUltraArchive.errorText)}).catch(()=>toast(proUltraArchive.errorText)).finally(()=>{r&&r.setAttribute("aria-hidden","true"),t.classList.remove("is-loading")})}i.forEach(e=>{e.addEventListener("click",()=>{u(e.getAttribute("data-view")),p()})}),e.addEventListener("change",t=>{t.target&&"security"!==t.target.name&&(e.querySelector('input[name\"page\"] ').value="1",p())}),s.forEach(e=>{const t=e.querySelector(".pro-ultra-filter__toggle"),a=e.querySelector("[data-filter-content]");t&&a&&t.addEventListener("click",()=>{const r="true"===t.getAttribute("aria-expanded");t.setAttribute("aria-expanded",r?"false":"true"),e.classList.toggle("is-open",!r),a.style.maxHeight=r?"":a.scrollHeight+"px"})}),d.forEach(t=>{t.addEventListener("input",()=>{const a=t.value.toLowerCase(),r=t.getAttribute("data-filter-search"),n=e.querySelectorAll(`[data-filter-item=\"${r}\"]`);n.forEach(e=>{const t=e.getAttribute("data-label")||"";e.style.display=t.indexOf(a)!==-1?"":"none"})})}),o&&n&&((c)=>{const e=c;const t=a=>{n.classList.toggle("is-open",a),document.body.classList.toggle("pro-ultra-filter-open",a)};o.addEventListener("click",()=>t(!0)),e&&e.addEventListener("click",()=>t(!1)),n.addEventListener("click",e=>{e.target===n&&t(!1)})})(c),a&&a.addEventListener("click",a=>{const r=a.target.closest("a");if(r){a.preventDefault();let n=r.dataset.page;if(!n)try{const e=new URL(r.href);n=e.searchParams.get("paged")||e.searchParams.get("page")}catch(e){n=1}e.querySelector('input[name\"page\"] ').value=n||"1",p(n||"1")}});const h=proUltraArchive.view||"grid";u(h)});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".pro-ultra-header"),t=document.querySelector("[data-mobile-nav]"),a=document.querySelector("[data-nav-overlay]"),r=document.querySelector("[data-nav-close]");if(t&&a){const e=e=>{a.classList.toggle("is-open",e),document.body.classList.toggle("pro-ultra-nav-open",e)};t.addEventListener("click",()=>e(!0)),r&&r.addEventListener("click",()=>e(!1)),a.addEventListener("click",t=>{t.target===a&&e(!1)})}if(e){let t=0;window.addEventListener("scroll",()=>{const a=window.pageYOffset||0;a>30&&a>t?e.classList.add("is-condensed"):a<10&&e.classList.remove("is-condensed"),t=a},{passive:!0})}});;document.addEventListener("DOMContentLoaded",function(){if(typeof proUltraArchive==="undefined")return;const e=document.querySelector('[data-archive-form]'),t=document.querySelector('[data-archive-list]'),a=document.querySelector('[data-archive-pagination]'),r=document.querySelector('[data-archive-loading]'),n=document.querySelector('[data-archive-aside]'),o=document.querySelector('[data-filter-open]'),c=document.querySelector('[data-filter-close]');if(!e||!t)return;const i=e.querySelectorAll('[data-view]'),l=e.querySelector('input[name\"view\"]'),s=e.querySelectorAll('[data-filter-section]'),d=e.querySelectorAll('[data-filter-search]');function u(n){const o="list"===n?"list":"grid";l&&(l.value=o),document.cookie=`pro_ultra_view=${o};path=/;`,i.forEach(e=>{e.setAttribute("aria-pressed",e.getAttribute("data-view")===o?"true":"false")}),document.body.classList.remove("pro-ultra-view-grid","pro-ultra-view-list"),document.body.classList.add(`pro-ultra-view-${o}`)}function p(a){const n=new FormData(e);a&&n.set("page",a),r&&r.setAttribute("aria-hidden","false"),t.classList.add("is-loading"),fetch(proUltraArchive.ajaxUrl,{method:"POST",body:n}).then(e=>e.json()).then(e=>{e.success&&e.data?(t.innerHTML=e.data.html,a&&e.data.view&&u(e.data.view),document.querySelector('[data-archive-pagination]')&&(document.querySelector('[data-archive-pagination]').innerHTML=e.data.pagination||"")):toast(e.data?.message||proUltraArchive.errorText)}).catch(()=>toast(proUltraArchive.errorText)).finally(()=>{r&&r.setAttribute("aria-hidden","true"),t.classList.remove("is-loading")})}i.forEach(e=>{e.addEventListener("click",()=>{u(e.getAttribute("data-view")),p()})}),e.addEventListener("change",t=>{t.target&&"security"!==t.target.name&&(e.querySelector('input[name\"page\"] ').value="1",p())}),s.forEach(e=>{const t=e.querySelector(".pro-ultra-filter__toggle"),a=e.querySelector("[data-filter-content]");t&&a&&t.addEventListener("click",()=>{const r="true"===t.getAttribute("aria-expanded");t.setAttribute("aria-expanded",r?"false":"true"),e.classList.toggle("is-open",!r),a.style.maxHeight=r?"":a.scrollHeight+"px"})}),d.forEach(t=>{t.addEventListener("input",()=>{const a=t.value.toLowerCase(),r=t.getAttribute("data-filter-search"),n=e.querySelectorAll(`[data-filter-item=\"${r}\"]`);n.forEach(e=>{const t=e.getAttribute("data-label")||"";e.style.display=t.indexOf(a)!==-1?"":"none"})})}),o&&n&&((c)=>{const e=c;const t=a=>{n.classList.toggle("is-open",a),document.body.classList.toggle("pro-ultra-filter-open",a)};o.addEventListener("click",()=>t(!0)),e&&e.addEventListener("click",()=>t(!1)),n.addEventListener("click",e=>{e.target===n&&t(!1)})})(c),a&&a.addEventListener("click",a=>{const r=a.target.closest("a");if(r){a.preventDefault();let n=r.dataset.page;if(!n)try{const e=new URL(r.href);n=e.searchParams.get("paged")||e.searchParams.get("page")}catch(e){n=1}e.querySelector('input[name\"page\"] ').value=n||"1",p(n||"1")}});const h=proUltraArchive.view||"grid";u(h)});document.addEventListener("DOMContentLoaded",function(){const e=document.querySelector(".pro-ultra-header"),t=document.querySelector("[data-mobile-nav]"),a=document.querySelector("[data-nav-overlay]"),r=document.querySelector("[data-nav-close]");if(t&&a){const e=e=>{a.classList.toggle("is-open",e),document.body.classList.toggle("pro-ultra-nav-open",e)};t.addEventListener("click",()=>e(!0)),r&&r.addEventListener("click",()=>e(!1)),a.addEventListener("click",t=>{t.target===a&&e(!1)})}if(e){let t=0;window.addEventListener("scroll",()=>{const a=window.pageYOffset||0;a>30&&a>t?e.classList.add("is-condensed"):a<10&&e.classList.remove("is-condensed"),t=a},{passive:!0})}});