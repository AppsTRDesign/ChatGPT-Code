                ...
                <ul class="splide__list">
                    <li class="splide__slide">
                        <a class="lightbox" href="<?= htmlspecialchars($mainImage) ?>" data-lightbox="product">
                            <img loading="lazy" class="main-image product-image" src="<?= htmlspecialchars($mainImage) ?>" alt="<?= htmlspecialchars($product['name']) ?>" title="<?= htmlspecialchars($product['name']) ?>">
                        </a>
                    </li>
                    <?php foreach ($gallery as $image): ?>
                        <li class="splide__slide">
                            <a class="lightbox" href="<?= htmlspecialchars($image['image_path']) ?>" data-lightbox="product">
                                <img loading="lazy" class="product-image" src="<?= htmlspecialchars($image['image_path']) ?>" alt="<?= htmlspecialchars($product['name']) ?>" title="<?= htmlspecialchars($product['name']) ?>">
                            </a>
                        </li>
                    <?php endforeach; ?>
                </ul>
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        <?php foreach ($similarProducts as $similar): ?>
                            <li class="splide__slide">
                                <article class="card">
                                    <img class="product-image" loading="lazy" src="<?= htmlspecialchars($similar['main_image'] ?: '/assets/images/placeholder.svg') ?>" alt="<?= htmlspecialchars($similar['name']) ?>" title="<?= htmlspecialchars($similar['name']) ?>">
                                    <div class="card-body">
