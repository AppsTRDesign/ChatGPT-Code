...
$active = 'contact';
$supportEmail = ns_config('mail.to', ns_config('site.noreply_email', 'destek@noasoft.org'));
include __DIR__ . '/includes/header.php';
?>
<section class="ns-tool">
    <h1>Bizimle İletişime Geçin</h1>
    <p>Öneri, destek ya da iş birliği talepleriniz için formu doldurmanız yeterli. Ayrıca bize doğrudan <strong><?= htmlspecialchars($supportEmail) ?></strong> adresinden ulaşabilirsiniz.</p>
