...
<section class="container section">
  ...
  <div class="contact-pro">
    ...
    <div class="panel"><div id="contactMap" style="height:430px"></div><?php if (empty($ymKey)): ?><p class="subtext">Yandex API key ayarlanmadığı için harita gösterilemiyor.</p><?php endif; ?></div>
  </div>
</section>
<?php if (!empty($ymKey)): ?>
