...
<main class="container py-4">
    ...
    <div class="card mb-3">
        <div class="card-body">
            <h2 class="h6">Yönetim Fabrikaları</h2>
            <p class="text-muted small mb-2">Tüm aktif şehirlere level 50 / max işçi 1000 yönetim fabrikası kurar (varsa günceller).</p>
            <form action="/admin/world/government-factories/seed" method="post" onsubmit="return confirm('Tüm şehirler için yönetim fabrikaları kurulsun/güncellensin mi?')">
                <input type="hidden" name="_csrf" value="<?= htmlspecialchars($csrf, ENT_QUOTES, 'UTF-8') ?>">
                <button class="btn btn-outline-primary btn-sm">Tüm Şehirlere Fabrika Aç</button>
            </form>
        </div>
    </div>
